...
class VisionAnalysisResponse(CamelModel):
    ...
    Estructura interna: campos anidados (detected_color_hsl contiene hue, saturation, lightness).
    Serialización JSON: campos aplanados (detected_hue, detected_saturation, detected_lightness).
    
    Esto se logra mediante un model_dump_json personalizado que flatten la estructura para Java.
    """
    clothing_id:           UUID
    predicted_category_id: UUID
    predicted_style_id:    UUID
    predicted_weather_id:  UUID
    predicted_occasion_id: UUID
    ...
    def model_dump_json(self, **kwargs) -> str:
        ...
        Estructura esperada por dressme-back y dressme-database:
        {
          ...
          "predictedWeatherId": UUID,
          "predictedOccasionId": UUID,
        ...
        data = {
            ...
            "predictedWeatherId": str(self.predicted_weather_id),
            "predictedOccasionId": str(self.predicted_occasion_id),
